...
// ImageProc_20190847View.cpp: CImageProc20190847View 클래스의 구현
//
...
#include "ImageProc_20190847.h"
#endif

#include "ImageProc_20190847Doc.h"
#include "ImageProc_20190847View.h"
#include <vfw.h>
...
// CImageProc20190847View

IMPLEMENT_DYNCREATE(CImageProc20190847View, CScrollView)

BEGIN_MESSAGE_MAP(CImageProc20190847View, CScrollView)
	// 표준 인쇄 명령입니다.
	//ON_COMMAND(ID_FILE_PRINT, &CScrollView::OnFilePrint)
	//ON_COMMAND(ID_FILE_PRINT_DIRECT, &CScrollView::OnFilePrint)
	//ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CScrollView::OnFilePrintPreview)
	ON_COMMAND(ID_PIXEL_ADD, &CImageProc20190847View::OnPixelAdd)
	ON_COMMAND(ID_PIXEL_SUB, &CImageProc20190847View::OnPixelSub)
	ON_COMMAND(ID_PIXEL_MUL, &CImageProc20190847View::OnPixelMul)
	ON_COMMAND(ID_PIXEL_DIV, &CImageProc20190847View::OnPixelDiv)
	ON_COMMAND(ID_PIXEL_HISTO_EQ, &CImageProc20190847View::OnPixelHistoEq)
	ON_COMMAND(ID_PIXEL_CONTRAST_STRETCHING, &CImageProc20190847View::OnPixelContrastStretching)
	ON_COMMAND(ID_PIXEL_BINARIZATION, &CImageProc20190847View::OnPixelBinarization)
	ON_COMMAND(ID_PIXEL_TWO_IMAGE_ADD, &CImageProc20190847View::OnPixelTwoImageAdd)
	ON_COMMAND(ID_PIXEL_TWO_IMAGE_SUB, &CImageProc20190847View::OnPixelTwoImageSub)
	ON_COMMAND(ID_PIXEL_TWO_IMAGE_MUL, &CImageProc20190847View::OnPixelTwoImageMul)
	ON_COMMAND(ID_PIXEL_TWO_IMAGE_DIV, &CImageProc20190847View::OnPixelTwoImageDiv)
	ON_COMMAND(ID_REGION_SMOOTHING, &CImageProc20190847View::OnRegionSmoothing)
	ON_COMMAND(ID_REGION_SHRAPENING, &CImageProc20190847View::OnRegionShrapening)
	ON_COMMAND(ID_REGION_EMBOSING, &CImageProc20190847View::OnRegionEmbosing)
	ON_COMMAND(ID_REGION_PREWITT, &CImageProc20190847View::OnRegionPrewitt)
	ON_COMMAND(ID_RREGION_ROBERTS, &CImageProc20190847View::OnRregionRoberts)
	ON_COMMAND(ID_RREGION_SOBEL, &CImageProc20190847View::OnRregionSobel)
	ON_COMMAND(ID_REGION_AVERAGE_FILTERING, &CImageProc20190847View::OnRegionAverageFiltering)
	ON_COMMAND(ID_REGION_MEDIAN_FILTERING, &CImageProc20190847View::OnRegionMedianFiltering)
	ON_COMMAND(ID_MOPOLOGY_COLOR_GRAY, &CImageProc20190847View::OnMopologyColorGray)
	ON_COMMAND(ID_MOPOLOGY_BINARIZATION, &CImageProc20190847View::OnMopologyBinarization)
	ON_COMMAND(ID_MOPOLOGY_EROSION, &CImageProc20190847View::OnMopologyErosion)
	ON_COMMAND(ID_MOPOLOGY_OPENING, &CImageProc20190847View::OnMopologyOpening)
	ON_COMMAND(ID_MOPOLOGY_DILATION, &CImageProc20190847View::OnMopologyDilation)
	ON_COMMAND(ID_MOPOLOGY_CLOSING, &CImageProc20190847View::OnMopologyClosing)
	ON_COMMAND(ID_GEOMETRY_ZOOMIN_PIXELCOPY, &CImageProc20190847View::OnGeometryZoominPixelcopy)
	ON_COMMAND(ID_GEOMETRY_ZOOMIN_BILINEARINTERPOLATION, &CImageProc20190847View::OnGeometryZoominBilinearinterpolation)
	ON_COMMAND(ID_GEOMETRY_ZOOMOUT_SUBSAMPLING, &CImageProc20190847View::OnGeometryZoomoutSubsampling)
	ON_COMMAND(ID_GEOMETRY_ZOOMOUT_MEAN_SUB, &CImageProc20190847View::OnGeometryZoomoutMeanSub)
	ON_COMMAND(ID_GEOMETRY_AVG_FILTERING, &CImageProc20190847View::OnGeometryAvgFiltering)
	ON_COMMAND(ID_GEOMETRY_ROTATIONT, &CImageProc20190847View::OnGeometryRotationt)
	ON_COMMAND(ID_GEOMETRY_HOLIZANTAL_FLIP, &CImageProc20190847View::OnGeometryHolizantalFlip)
	ON_COMMAND(ID_GEOMETRY_VERTICAL_FLIP, &CImageProc20190847View::OnGeometryVerticalFlip)
	ON_COMMAND(ID_GEOMETRY_WARPING, &CImageProc20190847View::OnGeometryWarping)
	ON_COMMAND(ID_GEOMETRY_MOPING, &CImageProc20190847View::OnGeometryMoping)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_COMMAND(ID_AVI_VIEW, &CImageProc20190847View::OnAviView)
	ON_COMMAND(ID_OPENCV, &CImageProc20190847View::OnOpencv)
END_MESSAGE_MAP()

// CImageProc20190847View 생성/소멸

CImageProc20190847View::CImageProc20190847View() noexcept
{
...
CImageProc20190847View::~CImageProc20190847View()
{
}

BOOL CImageProc20190847View::PreCreateWindow(CREATESTRUCT& cs)
{
...
// CImageProc20190847View 그리기

void CImageProc20190847View::OnDraw(CDC* pDC)
{
	CImageProc20190847Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (!pDoc)
		return;
...
void CImageProc20190847View::OnInitialUpdate()
{
...
// CImageProc20190847View 인쇄

BOOL CImageProc20190847View::OnPreparePrinting(CPrintInfo* pInfo)
{
	// 기본적인 준비
	return DoPreparePrinting(pInfo);
}

void CImageProc20190847View::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 인쇄하기 전에 추가 초기화 작업을 추가합니다.
}

void CImageProc20190847View::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: 인쇄 후 정리 작업을 추가합니다.
}


// CImageProc20190847View 진단

#ifdef _DEBUG
void CImageProc20190847View::AssertValid() const
{
	CScrollView::AssertValid();
}

void CImageProc20190847View::Dump(CDumpContext& dc) const
{
	CScrollView::Dump(dc);
}

CImageProc20190847Doc* CImageProc20190847View::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CImageProc20190847Doc)));
	return (CImageProc20190847Doc*)m_pDocument;
}
#endif //_DEBUG


// CImageProc20190847View 메시지 처리기




void CImageProc20190847View::OnPixelAdd()
{
...
void CImageProc20190847View::OnPixelSub()
{
...
void CImageProc20190847View::OnPixelMul()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelDiv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelHistoEq()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelContrastStretching()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelBinarization() // 이진화
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::LoadTwoImage()
{
	// TODO: 여기에 구현 코드 추가.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnPixelTwoImageAdd()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelTwoImageSub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelTwoImageMul()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnPixelTwoImageDiv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::Convolve(unsigned char** Inimg, unsigned char** Outimg, int cols, int rows, float mask[][3], int bias, int depth)
{
	// TODO: 여기에 구현 코드 추가.
...
void CImageProc20190847View::OnRegionSmoothing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRegionShrapening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRegionEmbosing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRegionPrewitt()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRregionRoberts()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRregionSobel()
{
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnRegionAverageFiltering() // 컬러처리 안함 영상에있으니 나중에 하기
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnRegionMedianFiltering() //잡음 더 생김 다시 해보기
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnMopologyColorGray()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnMopologyBinarization()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnMopologyErosion()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnMopologyDilation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnMopologyOpening() //침식연산
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::CopyResultToInput() 
{
	// TODO: 여기에 구현 코드 추가.
...
void CImageProc20190847View::OnMopologyClosing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnGeometryZoominPixelcopy()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnGeometryZoominBilinearinterpolation() 
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnGeometryZoomoutSubsampling()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnGeometryZoomoutMeanSub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	OnRegionMeaning();
	CopyResultToInput();
...
void CImageProc20190847View::OnGeometryAvgFiltering() 
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	for (i = 0; i < pDoc->gimageHeight; i++)
	{
		pDoc->gresultImg[i] = (unsigned char*)malloc(pDoc->imageWidth * pDoc->depth);
	}
...
void CImageProc20190847View::OnGeometryRotationt()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	...
	ydiff = (pDoc->gimageWidth - pDoc->imageHeight) / 2;
...
void CImageProc20190847View::OnGeometryHolizantalFlip()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnGeometryVerticalFlip()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::OnGeometryWarping()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CImageProc20190847Doc* pDoc = GetDocument();
...
void CImageProc20190847View::OnGeometryMoping()
{
...
void CImageProc20190847View::OnLButtonDown(UINT nFlags, CPoint point) // 마우스 클릭
{
...
void CImageProc20190847View::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 여기에 메시지 처리기 코드를 추가 및/또는 기본값을 호출합니다.
...
void CImageProc20190847View::OnAviView()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CImageProc20190847View::LoadAviFile(CDC* pDC)
{
	// TODO: 여기에 구현 코드 추가.
	PAVIFILE pavi;
	AVIFILEINFO fi;
...
//--------------------------------------------------------------------------
void CImageProc20190847View::OnOpencv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	COpenCVDlg dlg;
...
void CImageProc20190847View::OnRegionMeaning()
{
	CImageProc20190847Doc* pDoc = GetDocument();
